...
4. Auf <https://covid19-dashboard.ages.at/data/CovidFaelle_Timeline.csv> sind Daten zu den täglichen Covid19-Neuinfektionen in Österreich zu finden. Importieren Sie diese Datei in R (achten Sie auf geeignete Argumente, um die Datei richtig einzulesen wie z.B. das korrekte Spaltentrennzeichen sowie Dezimaltrennzeichen)! Aus wie vielen Zeilen und Spalten besteht dieser Datensatz?
