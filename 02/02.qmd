...
Install the packages `readr`, `Hmisc`, and `psych` – try using both the RStudio GUI and R commands! Determine the versions of these three packages. How can you uninstall/remove a package?
...
Read the documentation of `sum()` to answer the following questions:
